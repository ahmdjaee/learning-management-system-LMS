                                                       ...
                                                       @foreach ($chapter->lessons as $lesson)
                                                        <li class="{{ $lesson->is_preview ?  'active' : '' }}">
                                                            ...
                                                            @if ($lesson->is_preview == 1 )
                                                                <a class="right_text venobox vbox-item" data-autoplay="true" data-vbtype="video"
                                                                    href="{{ $lesson->file_path }}"
                                                                    >Preview</a>
                                                            @else
                                                                <span class="right_text">{{ convertMinutesToHours((int)$lesson->duration) }}</span>
                                                            @endif
                                                        </li>
                                                       @endforeach
                                                    </ul>
                                        ...
                                        <div class="col-lg-8 col-md-6">
                                            <div class="wsus__courses_instructor_text">
                                                ...
                                                <ul class="link d-flex flex-wrap">
                                                    ...
                                                    <li><a href="{{ $course->instructor->website }}"><i class="fab fa-firefox-browser"></i></a></li>
                                                    @endif
                    ...
                    <div class="wsus__courses_sidebar">
                        ...
                        <div class="wsus__courses_sidebar_share_area">
                            ...
                            <ul>
                                ...
                                <li class="ez-pinterest"><a href="#"><i class="fab fa-pinterest"></i></a></li>
                            </ul>
                        </div>

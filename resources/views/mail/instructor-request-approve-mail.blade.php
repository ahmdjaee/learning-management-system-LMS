        ...
        <div class="content">
          ...
          >
            ...
            <tr>
              <td class="wrapper">
                <p>Hi there</p>
                <p>Your instructor request has been approved. From now you will be able to publish course in our site!</p>

                <p>Please visit your dashboard from here: <a class="btn btn-primary" href="{{ url('/instructor/dashboard') }}">Instructor Dashboard</a></p>
                <p>Good luck!</p>
              </td>
            </tr>

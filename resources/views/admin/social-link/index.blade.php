      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-actions">
            <a class="btn btn-primary btn-3" href="{{ route('admin.social-links.create') }}">
                  ...
                  <tr>
                    <td>
                      <img
                        ...
                        alt=""
                        width="100"
                        style="background-color: rgba(128, 128, 128, 0.422); aspect-ratio: 1/1; object-fit: contain;"
                      >
                    </td>
                    <td>{{ $social->url }}</td>
                    ...
                    <td class="text-end ">
                      <a
                        ...
                        href="{{ route('admin.social-links.edit', $social->id) }}"
                        title="Edit"
                      >
                      ...
                      <a
                        ...
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        href="{{ route('admin.social-links.destroy', $social->id) }}"
                        title="Delete"
                      >

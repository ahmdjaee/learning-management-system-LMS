      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-actions">
            <a class="btn btn-primary btn-3" href="{{ route('admin.useful-links.create') }}">
                  ...
                  <tr>
                    ...
                    <td class="text-end ">
                      <a
                        ...
                        href="{{ route('admin.useful-links.edit', $link->id) }}"
                        title="Edit"
                      >
                      ...
                      <a
                        ...
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        href="{{ route('admin.useful-links.destroy', $link->id) }}"
                        title="Delete"
                      >

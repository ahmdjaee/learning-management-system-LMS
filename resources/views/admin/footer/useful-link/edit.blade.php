    ...
    <div class="container-xl">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Create Useful Links</h3>
          <div class="card-actions">
            <a class="btn btn-primary btn-3" href="{{ route('admin.useful-links.index') }}">
        ...
        <div class="card-body">
          <form
            action="{{ route('admin.useful-links.update', $link->id) }}"
            method="post"

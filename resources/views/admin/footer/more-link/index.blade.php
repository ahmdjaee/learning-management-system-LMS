    ...
    <div class="container-xl">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">More Links</h3>
          <div class="card-actions">
            <a class="btn btn-primary btn-3" href="{{ route('admin.more-links.create') }}">
                  ...
                  <tr>
                    ...
                    <td class="text-end ">
                      <a
                        ...
                        href="{{ route('admin.more-links.edit', $link->id) }}"
                        title="Edit"
                      >
                      ...
                      <a
                        ...
                        data-bs-toggle="tooltip"
                        data-bs-placement="top"
                        href="{{ route('admin.more-links.destroy', $link->id) }}"
                        title="Delete"
                      >

...
class CourseLanguageController extends Controller
{
    ...
    {
        $request->validate(['name' => ['required', 'string', 'max:255', 'unique:course_languages']]);
    ...
    {
        $request->validate(['name' => ['required', 'string', 'max:255', 'unique:course_languages,name,' . $course_language->id]]);
    ...
    public function destroy(CourseLanguage $course_language)
    {
        try {
            ...
            logger("Course Language Delete Error - ".$th);

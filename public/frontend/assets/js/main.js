$(function () {
    ...
    $(".categoty_list li").each(function () {
        ...
        // Set initial height only if there is a checked input inside submenu
        if (submenu.find("input:checked").length > 0) {
    ...
    $(".basic").alRangeSlider();
    const options = {
        range: { min: 0, max: 10000, step: 5 },
        initialSelectedValues: { from: 0, to: 10000 },
